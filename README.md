...
An NLP-powered web app that turns a meeting recording (or transcript) into a **summary**, a list of **key takeaways**, and a set of **actionable insights / action items**.
...
You upload a meeting (audio/video file, or paste an existing transcript). SummarAI:
1. **Transcribes** the audio into text (speech-to-text).
2. **Reads** the transcript and produces:
